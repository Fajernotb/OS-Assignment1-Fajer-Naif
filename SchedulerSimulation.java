...
public class SchedulerSimulation {
    public static void main(String[] args) {
        ...
        int studentID = 445052157;  // ← CHANGE THIS TO YOUR ACTUAL STUDENT ID
        ...
        for (int i = 1; i <= numProcesses; i++) {
           ...
           int priority = 1 + random.nextInt(5); // random priority من 1 لـ 5
Process process = new Process("P" + i, burstTime, timeQuantum, priority); //Feature1
